                ...
                <ul class="nav-list">
                    ...
                    <li>
                        ...
                        <ul class="drop-menu2">
                            ...
                            <li><a href="/BlajevStyle/store page/woman.php">Жени</a></li>
    ...
    <main class="main">
        ...
        <div id="wrapper">
            ...
            if ($isAdmin == 1) {
                ...
                <button type="submit" name="submit">Добави продукт</button>
            </form>';
            }
            ?>
            <div id="flex">
                ...
                foreach ($aProductsRows as $productRow) {
                    ...
                    foreach ($aImagesRows as $imageRow) {
                        ...
                        // array_push($images, $imageRow['indication']);
                        // array_push($images, $imageRow['type']);
                    }
                ...
                foreach ($products as $product) {
                    ...
                    // echo "<li><img src=\"https://lp2.hm.com/hmgoepprod?set=format%5Bwebp%5D%2Cquality%5B79%5D%2Csource%5B%2Fe3%2F6c%2Fe36c3b0bff92f3c77c0bdfbbb91448e87a9a16af.jpg%5D%2Corigin%5Bdam%5D%2Ccategory%5B%5D%2Ctype%5BLOOKBOOK%5D%2Cres%5Bm%5D%2Chmver%5B1%5D&call=url%5Bfile%3A%2Fproduct%2Fmain%5D\" alt = \"\"></li>";
                    echo "</ul>";
